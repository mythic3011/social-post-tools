...
checks = {
  ...
  'provider-policy-migrates-nitter': "DEFAULT_X_BUILDER = 'fixupx'" in provider_policy and "'nitter-net'" in provider_policy and 'migrateSettings' in provider_policy,
  'provider-policy-curated-status': 'provider-status-list' in settings and 'renderProviderSummary' in provider_policy and "capability: 'reader'" in provider_policy and "capability: 'embed'" in provider_policy,
