...
"$PYTHON_BIN" "$ROOT/tests/provider_policy_audit.py"
"$PYTHON_BIN" "$ROOT/tests/link_lab_audit.py"
"$PYTHON_BIN" "$ROOT/tests/share_target_enhancement_audit.py"
"$PYTHON_BIN" "$ROOT/tests/ui_structure_audit.py"
"$PYTHON_BIN" "$ROOT/tests/ui_browser_smoke.py"
"$PYTHON_BIN" "$ROOT/tests/link_lab_browser.py"
"$PYTHON_BIN" "$ROOT/tests/share_target_enhancement_browser.py"
